...
; remastered by TeamBurdah to meet hardware compatibility on Burdah (C) 2026
;
...
szStartup   	DB 'HimemX ', VERSIONSTR, ' [', @CatStr(!"%@Date!"), '] Original by Till Gerken and Tom Ehlert. Rebuild by Team Burdah for Burdah DOS System.',  0aH,  00H
if ?TESTMEM
