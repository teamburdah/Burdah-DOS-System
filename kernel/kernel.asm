...
Version_OemID               db 0xBB     ; OEM_ID (Burdah, was 0xFD/FreeDOS)
Version_Major               db 2
...
; Burdah: runtime-overridable OEM ID, default = Burdah's own ID.
; Can be changed at boot via OEMID= in CONFIG.SYS (e.g. OEMID=0xFD to
; masquerade as FreeDOS for software that misbehaves otherwise).
                global  _oem_id
_oem_id         db      0xBB
