...
/* Define to support kernel-supported swapout of Portal
    see DOCS\K-SWAP.TXT
*/
#define FEATURE_KERNEL_SWAP_SHELL

/* Define to support XMS-only swap support of Portal
...
#error "Portal cannot support both Kernel- and XMS-based swapping simultaneously"
#endif
