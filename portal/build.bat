...
echo no-xms-swap: Build Portal without XMS-Only Swap support
echo debug: Build Portal with debug settings.
echo plainedt: Build Portal without enhanced line editing/history
echo You can select for which language to built Portal by setting
...
echo Building Portal for language %LNG%
...
echo Note: To build Portal without XMS-Only Swap, re-run
