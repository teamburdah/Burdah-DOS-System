; ===============================================
; Bootloader (FAT32 - non LBA)
; THIS FILE IS A PART OF BURDAH-DOS 0.5
; Target Release: 17 August 2026
; ===============================================
...
info_BurdahLoad db "Loading System...",0

       times 0x01ee-$+$$ db 0

msg_BootError	db "No "
		; currently, only "burdah.sys not found" gives a message,
		; but read errors in data or root or fat sectors do not.

	magicoffset "kernel name", 1F1h
filename	db "BURDAH  SYS"
