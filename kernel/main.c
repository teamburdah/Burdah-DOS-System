...
static char copyright[] =
    "(C) Copyright 2026 Team Burdah project. All Rights Reserved.\n"
    "In essence, the license of this software (Burdah DOS System) is based\n"
	"on the license of the parent software (FreeDOS).\n"
    "WARRANTY; as stated in the GNU General Public License license agreement\n"
	"as free software that can be modified. ";
...
STATIC void init_kernel(void)
{
  ...
  */
  ...
  /* Load Boot Splash (BURDAH.SYS / LOGO.SYS) if present */
  splash_init();
  ...
  /* Restore text mode before launching shell if splash is active */
  splash_close();
}
